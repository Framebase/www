...
//     alert();
//   // Create CSS
//   var upcss = document.createElement('LINK');
//   upcss.href = '/assets/css/framebaseuploader.css';
//   upcss.rel = 'stylesheet';
//   upcss.type = 'text/css';
...
//         element: $('#framebase-uploader')[0],
//         request: {
//             endpoint: "http://10.10.16.28/videos",
//             token: 'tiwjfw'
//         },
//         callbacks: {
//             onComplete: function(responseJSON){console.log(responseJSON)}
//         }
//     });
// };
...
var qq = function(element) {
    ...
    // // Replace input tag
    // var uploader = document.getElementById('framebase-uploader');
    // var uploaderDiv = document.createElement('div');
    // uploaderDiv.id = 'framebase-uploader';

    // uploader.parentNode.appendChild(uploaderDiv);
    // uploader.parentNode.removeChild(uploader);vv
...
qq.UploadButton = function(o){
    this._options = {
        element: document.getElementById('framebase-uploader'),
...
qq.UploadHandlerXhr = function(o, uploadCompleteCallback, logCallback) {
    ...
    function setParamsAndGetEntityToSend(params, xhr, fileOrBlob, id) {
        var formData = new FormData(),
            ...
            name = api.getName(id),
            size = api.getSize(id);
            qq.log(options.token);
            qq.log(options);

        // params[options.uuidParamName] = fileState[id].uuid;
        params[options.uuidParamName] = 'xyzzy';
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: 'fewew or drag and drop a video from your computer',
