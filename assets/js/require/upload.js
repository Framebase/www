...
qq.UploadHandlerForm = function(o, uploadCompleteCallback, logCallback) {
    ...
    function getIframeContentJson(iframe) {
        ...
        try {
            ...
            // alert('Error when attempting to parse form upload response (' + error + ")", 'error');
    ...
    function createForm(id, iframe){
        var params = options.paramsStore.getParams(id),
            ...
            // Do postMessage if IE9 and below
            if(qq.ie() && !qq.ie10()) {
                url += 'html';
                endpoint += 'html';
            }
        ...
        addHiddenInput(form, 'token', '7e2d397e7c52137284759831f0bf502fb0ba53865788a12e6759acd0ee39a5fd');
        addHiddenInput(form, 'domain', location.protocol + "//" + document.domain);
    ...
    api = {
        ...
        upload: function(id){
            ...
            // Bind for postMessage callback
            eventer(messageEvent,function(e) {
                e = JSON.parse(e.data);
                options.onComplete(id, fileName, e);
            },false);
...
qq.UploadHandlerXhr = function(o, uploadCompleteCallback, logCallback) {
    ...
    function setParamsAndGetEntityToSend(params, xhr, fileOrBlob, id) {
        ...
        params[options.uuidParamName] = '7e2d397e7c52137284759831f0bf502fb0ba53865788a12e6759acd0ee39a5fd';
    ...
    function isErrorResponse(xhr, response) {
        return xhr.status !== 200 || !response.response == 200 || response.reset;
    }
    ...
    function handleStandardFileUpload(id) {
        ...
        // toSend.append("cookie=banana");
        setHeaders(id, xhr);
        log('Sending upload request for ' + id);
        toSend.append("token", "7e2d397e7c52137284759831f0bf502fb0ba53865788a12e6759acd0ee39a5fd");
...
qq.FineUploaderBasic.prototype = {
    ...
    _createUploadHandler: function(){
        ...
        return new qq.UploadHandler({
            ...
            token: this._options.request.token,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: 'Choose or drag and drop a video from your computer',
            descriptionButtonText: 'MOV, AVI, MPEG-4 - 1000MB file limit',
            cancelButton: 'Cancel',
            retryButton: 'Retry',
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="qq-upload-button"><div class="qq-upload-header">{uploadButtonText}</div><div>{descriptionButtonText}</div></div>' : '') +
    ...
    this._options.template     = this._options.template.replace(/\{descriptionButtonText\}/g, this._options.text.descriptionButtonText);
